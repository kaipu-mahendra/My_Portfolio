  ...
  return (
    <section id="experience" className="py-12 sm:py-16 scroll-mt-24">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-xl sm:text-2xl font-bold">Experience & Achievements</h2>
        ...
        <Section title="Research Publication">
          <div className="p-4 sm:p-6 rounded-xl border bg-white">
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <div className="font-semibold text-sm sm:text-base">Problem Statement</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">Approach & Methodology</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <div className="font-semibold text-sm sm:text-base">Key Contributions</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">What I Learned</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
        ...
        <Section title="Web Development Internship — Csedge">
          <div className="p-4 sm:p-6 rounded-xl border bg-white">
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div>
                <div className="font-semibold text-sm sm:text-base">Responsibilities</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">Skills Gained</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
              ...
              <div>
                <div className="font-semibold text-sm sm:text-base">Impact</div>
                <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-2 text-sm sm:text-base">
        ...
        <Section title="Certifications & Achievements">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="p-4 sm:p-6 rounded-xl border bg-white">
              <div className="text-base sm:text-lg font-semibold">Oracle Foundations of Artificial Intelligence</div>
              <a
              ...
              <ul className="list-disc pl-5 sm:pl-6 space-y-1 mt-3 sm:mt-4 text-sm sm:text-base">
            ...
            <div className="p-4 sm:p-6 rounded-xl border bg-white">
              <div className="text-base sm:text-lg font-semibold">Oracle Generative AI Professional</div>
              <a
        ...
        <Section title="NASA Space Apps Challenge — Participant">
          <div className="p-4 sm:p-6 rounded-xl border bg-white">
            <div className="text-base sm:text-lg font-semibold">NASA Space Apps Challenge — Participant</div>
            <a
