...
export default function Hero() {
  return (
    <section id="about" className="bg-gray-50 scroll-mt-24 hero-bg relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-[1fr,auto] gap-10 items-center relative">
        <div>
          <div className="text-sm text-gray-600 font-medium tracking-wide uppercase mb-2">Kaipu Mahendra</div>
